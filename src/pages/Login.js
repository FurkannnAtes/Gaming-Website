    ...
    return (
        <div className="overflow-x-hidden  overflow-y-visible bg-[rgb(14,1,49)] ">
            ...
            <div className='bg-[url("https://bonx-react.pages.dev/static/breadcrumbs-bg-aead09dfeb2feab4bfcb4b524bd0b9a5.webp")] h-[420px] flex flex-col justify-center items-center text-white gap-10'>
                <h1 className='text-3xl xl:text-7xl creepster-font' style={{ textShadow: "3px 3px rgb(177,84,240)" }}>Login</h1>
                <h2>   <span className='hover:text-[rgb(177,84,204)] duration-300 cursor-pointer'>HOME</span> <span className='hover:text-[rgb(177,84,204)] duration-300 cursor-pointer'>     / </span> <span className='hover:text-[rgb(177,84,204)] duration-300 cursor-pointer'>LOGIN</span> </h2>
            </div>
            <div className='flex flex-col px-5 py-20 mx-auto lg:px-20 lg:flex-row'>
                ...
                <div className='flex flex-col justify-center w-full gap-5 text-white lg:px-20'>
                    ...
                    <form className='flex flex-col w-full gap-5 text-white '>
                        ...
                        <button className='flex items-center gap-2 w-[200px] h-[60px] text-xl font-extrabold justify-center mx-auto rounded-xl duration-300 hover:gap-3 bg-[rgb(177,84,204)]' type='submit'><span>Login</span> <span> <i className="bi bi-arrow-right-short 2xl"></i></span></button>
                        <p className='text-center'>Do not have any account,<Link to="/signup" className='font-extrabold text-yellow-300'> Signup here</Link></p>
                    </form>
